...
public class MailSender {
    ...
    static void sendMail(List<Addressee> to, List<Addressee> cc, String subject, String body) {
        ...
        try {
            ...
            mailStatus = Throwables.getRootCause(e).getMessage();
        }
        mailDao.insert(MailEntity.of(to, cc, subject, body, mailStatus));
    }
}
